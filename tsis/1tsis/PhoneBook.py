...
# # while True:
# #     print(" add the contact: 1")
# #     print("update the contact: 2")
# #     print("show the contact: 3")

# #     choice = input("PLS choose the option: ")

# #     if choice == '1':
# #         name = input("enter the name: ")
# #         number = int(input("enter the number: "))
# #         print('The contact added succesfully ')
# #     elif choice == '2':
# #         id = int(input("ent2er the ID"))
# #     elif choice == '3':
# #         all = input("show")
